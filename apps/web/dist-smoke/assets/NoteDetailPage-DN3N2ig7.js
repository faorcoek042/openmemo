import { m as qk, o as mediaUrl, r as MockNotice, t as ErrorBlock } from "./ErrorBlock-NhqIUn2X.js";
import { i as SEGMENT_FLAG, n as isMockEnabled } from "./mock-8ZZ8pRo5.js";
...
import { o as useTranscriptQuery, r as useNoteQuery, t as NoteProgressLine } from "./NoteProgressLine-8XPY9COY.js";
import { r as MindmapView, t as useMindmapQuery } from "./api-CcIiObhZ.js";
...
import { AlertTriangle, Pause, Play, Type } from "lucide-react";
...
function TranscriptList({ segments, speakerNames }) {
	const highlightGranularity = segments.some((s) => s.words && s.words.length > 0) ? "word" : "sentence";
...
//#endregion
//#region src/features/transcript/WordLevelBadge.tsx
/**
* 逐字高亮可用性徽标（ADR-013 §0）。
*
...
*/
function WordLevelBadge({ segments }) {
	const { t } = useTranslation();
	if (segments.length === 0) return null;
	if (segments.some((s) => s.words && s.words.length > 0)) return null;
...
function NoteDetailPage() {
	...
	const mindmap = useMindmapQuery(tab === "mindmap" ? noteUid : void 0);
				...
				children: [/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("h2", {
							...
							children: [
								t("detail.transcript"),
								/* @__PURE__ */ jsx(MockNotice, {
									surface: "transcript",
									compact: true
								}),
								/* @__PURE__ */ jsx(WordLevelBadge, { segments: transcript.data?.segments ?? [] })
							]
						}), /* @__PURE__ */ jsxs("label", {
					...
					children: [/* @__PURE__ */ jsx("nav", {
						...
						}) : tab === "mindmap" ? mindmap.data ? /* @__PURE__ */ jsx("div", {
							className: "-m-4 h-[60vh]",
							children: /* @__PURE__ */ jsx(MindmapView, { doc: mindmap.data })
						}) : /* @__PURE__ */ jsx("p", {
							className: "text-ink-muted",
							children: t("mindmap.empty")
						}) : /* @__PURE__ */ jsx("p", {
							className: "text-ink-muted",
