...
import { a as timecode, n as estimateRerunMs, r as humanDuration } from "./time-BT6YJuzy.js";
...
function RecorderPage() {
	...
	*/
	const [engine, setEngine] = useState("paraformer");
	const [replaced, setReplaced] = useState(null);
	const portDrift = useConnectionStore((s) => s.portDrift);
	const levelRef = useRef(null);
	const timerRef = useRef(null);
	const rerunEtaMs = estimateRerunMs(elapsed || 36e5, engine === "paraformer" ? 84 : 2.7);
	const rerunEtaLabel = rerunEtaMs ? humanDuration(rerunEtaMs, i18n.language) : null;
	const rerunRemainLabel = rerunEtaMs ? humanDuration((1 - rerunProgress) * rerunEtaMs, i18n.language) : null;
	useEffect(() => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			phase === "recording" || phase === "idle" ? /* @__PURE__ */ jsxs("div", {
				className: "space-y-1 rounded-md border border-line bg-surface-1 p-3 text-xs text-ink-secondary",
				children: [
					/* @__PURE__ */ jsxs("p", {
						...
						children: [
							/* @__PURE__ */ jsxs("span", {
								...
								children: [t("recorder.engineLabel"), ":"]
							}),
							/* @__PURE__ */ jsx("span", { children: engine === "paraformer" ? t("recorder.engineParaformer") : t("recorder.engineTurbo") }),
							/* @__PURE__ */ jsx(Button, {
								size: "sm",
								variant: "ghost",
								className: "h-5 px-1.5 text-xs",
								onClick: () => setEngine((e) => e === "paraformer" ? "turbo" : "paraformer"),
								children: engine === "paraformer" ? t("recorder.switchToTurbo") : t("recorder.switchToParaformer")
							})
						]
					}),
					/* @__PURE__ */ jsxs("p", { children: [
						"ⓘ",
						" ",
						engine === "paraformer" ? t("recorder.paraformerNotice") : rerunEtaLabel ? t("recorder.twoPhaseNoticeWithEta", { eta: rerunEtaLabel }) : t("recorder.twoPhaseNotice")
					] }),
					/* @__PURE__ */ jsx("p", {
						className: "text-ink-muted",
						children: engine === "paraformer" ? t("recorder.paraformerTradeoff") : t("recorder.turboTradeoff")
					})
				]
			}) : null,
			phase === "rerunning" ? /* @__PURE__ */ jsxs("section", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							className: "text-ink",
							children: rerunRemainLabel ? t("recorder.rerunningWithEta", {
								model: "large-v3-turbo",
								eta: rerunRemainLabel
			...
			replaced ? /* @__PURE__ */ jsx(Banner, {
				...
				detail: /* @__PURE__ */ jsxs(Fragment, { children: [replaced.noCounterpart > 0 ? /* @__PURE__ */ jsx("span", { children: t("recorder.replacedNoCounterpart", { count: replaced.noCounterpart }) }) : null, /* @__PURE__ */ jsx("span", {
					className: "mt-0.5 block text-ink-muted",
					children: t("recorder.mergeByTimeNote")
				})] }),
