import { a as api, c as setCsrf, d as createQueryClient, f as qk, i as formatSpeed, n as formatBytes, o as consumeHandoffToken, r as formatPercent, t as ErrorBlock, u as STALE_TIME_OVERRIDES } from "./assets/ErrorBlock-yofocnTu.js";
import { i as bus, n as isMockEnabled, t as installMockApi } from "./assets/mock-D4lXt2Xs.js";
import { n as useUiStore, t as applyTheme } from "./assets/ui.store-Ycv0FflS.js";
...
import { n as initI18n } from "./assets/i18n-CjfVoQxd.js";
import { t as Banner } from "./assets/Banner-C-cOOcHq.js";
import { a as ProgressMeter, o as Button, t as approxEta } from "./assets/time-Dn1EgsA-.js";
import { t as StatusChip } from "./assets/StatusChip--dKLeohu.js";
import { t as EmptyState } from "./assets/EmptyState-Bc3D_rF1.js";
import { Suspense, act, createElement, lazy, useEffect, useMemo, useState } from "react";
import { createRoot } from "react-dom/client";
import { Link, NavLink, Navigate, Outlet, createMemoryRouter, useParams } from "react-router";
import { RouterProvider } from "react-router/dom";
import { QueryClientProvider, useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useTranslation } from "react-i18next";
import { Activity, AlertTriangle, ArrowLeft, Ban, Boxes, Check, CheckCircle2, ChevronDown, CircleDashed, Cpu, Download, ExternalLink, FileAudio, Gauge, HardDrive, Info, Lock, MemoryStick, Mic, MonitorCog, OctagonAlert, Package, Play, Plus, RefreshCw, Settings, ShieldCheck, Star, Trash2, X, XCircle, Zap } from "lucide-react";
...
function App() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			isMockEnabled() ? /* @__PURE__ */ jsx(Banner, {
				tone: "mock",
				title: t("banner.mockTitle"),
				detail: t("banner.mockDetail")
			}) : null,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("nav", {
					...
					children: [/* @__PURE__ */ jsx("header", {
						className: "flex h-11 shrink-0 items-center justify-end gap-2 border-b border-line bg-surface-1 px-4",
						children: activeCount > 0 ? /* @__PURE__ */ jsxs(Button, {
							size: "sm",
							variant: "ghost",
...
*/
var CapturePage = lazy(() => import("./assets/CapturePage-CbY13_Z8.js"));
var captureRoutes = [{
	path: "capture",
...
*/
function useModelsCatalogQuery(role = "all") {
	return useQuery({
		queryKey: [...qk.models.catalog, role],
		queryFn: () => api(`/models/catalog?role=${role}`),
...
function FitEta({ fitness }) {
	if (fitness.estMinutesPerAudioHour == null) return /* @__PURE__ */ jsx("span", {
	...
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [
			"估算：1 小时音频约 ",
			Math.round(fitness.estMinutesPerAudioHour),
			" 分钟"
		]
	});
}
...
function ModelsPage() {
	...
	const groups = useMemo(() => {
		return (catalog.data?.groups ?? []).filter((g) => g.role === role).filter((g) => onlyRunnable ? g.variants.some((v) => v.fitness.tier === "recommended" || v.fitness.tier === "slow_partial") : true);
	}, [
		catalog.data,
		role,
		onlyRunnable
...
var NotesListPage = lazy(() => import("./assets/NotesListPage-iXgO3awl.js"));
var NoteDetailPage = lazy(() => import("./assets/NoteDetailPage-D6zk0bhX.js"));
var notesRoutes = [
	{
		index: true,
...
var RecorderPage = lazy(() => import("./assets/RecorderPage-DDlbkFhB.js"));
var recorderRoutes = [{
	path: "record",
...
var SettingsPage = lazy(() => import("./assets/SettingsPage-aeg1rJjm.js"));
var settingsRoutes = [{
	path: "settings",
	element: /* @__PURE__ */ jsx(Navigate, {
		to: "/settings/general",
