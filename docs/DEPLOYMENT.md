...
| -------------------------------------- | --------------------------- | -------------------- | -------------- | ----------------------------------------------- | ---------------------------------------- |
| **Linux x64**                          | **6 / 23** `[A]` ~~5 / 22~~ | **5** `[A]`          | **0** `[A]`    | CPU + **Vulkan**（包已进目录且**装成功**）`[A]` | ✅ **2.1s** · 108 字符 `[A]`             |
| **Windows x64**                        | **5 / 23** `[A]` ⚠️ 见下    | **5** `[A]`          | **0** `[A]`    | 只有 CPU（CUDA 见下）`[A]`                      | ✅ **4.0s** · 108 字符 `[A]` ~~3.6s~~    |
| **macOS arm64**                        | **5 / 23** `[A]` ⚠️ 见下    | **5** `[A]`          | **0** `[A]`    | CPU + Metal + CoreML **同在核心包里** `[A]`     | ✅ **95.2s** · 108 字符 `[A]` ~~106.1s~~ |
...
#### ⚠️ 这张表有两格今天已经追不上目录了（`[未验证]`，需要新跑一轮才能填）
